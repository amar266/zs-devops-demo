...
project_id = None
try:
    send_url = 'https://console.zerostack.net/v2/clusters/%s/projects'%(region_id)
...
try:
   send_url = 'https://console.zerostack.net/v2/clusters/%s/projects/%s'%(region_id,project_id)
   data = '{"description":"DevOps Control Project for %s devops BU.","domain_id":"%s","name":"DvOps Control","finite_duration":false,\
...
subnet_id = None
try:
    send_url = 'https://console.zerostack.net/v2/clusters/%s/networks'%(region_id)
...
ext_net_id = None
try:
    send_url = 'https://console.zerostack.net/v2/clusters/%s/networks/?visibility=public&domain_id=%s&project_id=%s'%(region_id,domain_id,project_id)
    r = requests.get(send_url,verify = False,headers={"content-type":"application/json","X-Auth-Token":token})
...
try:
    send_url = 'https://console.zerostack.net/v2/clusters/%s/networks/%s'%(region_id,network_id)
...
for vm in control_vms:
   ...
   try:
       send_url = 'https://console.zerostack.net/v2/clusters/%s/projects/%s/vm'%(region_id,project_id)
...
try:
    send_url = 'https://console.zerostack.net/v2/clusters/%s/app_templates'%(region_id)
...
for vm in pipeline_vms:
   ...
   try:
       send_url = 'https://console.zerostack.net/v2/clusters/%s/projects/%s/vm'%(region_id,pipe_project_id)
